A Next.Js boilerplate can be added directly using [`create-next-app`].
...
Open [http://localhost:3000/spaceXData](http://localhost:3000/spaceXData) with your browser to see the result.
